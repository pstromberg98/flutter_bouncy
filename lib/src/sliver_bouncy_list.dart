...
class RenderSliverBouncyList extends RenderSliverMultiBoxAdaptor {
  ...
  @override
  bool hitTestSelf({required double mainAxisPosition, required double crossAxisPosition}) => true;
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    while (child != null) {
      ...
      if (springMap[child] != null) {
        ...
        childOffset += isVertical
            ? Offset(0, spring!.current)
            : Offset(spring!.current, 0);
      }
...
class Spring {
  ...
  Spring(this.handler, this.springDescription) {
