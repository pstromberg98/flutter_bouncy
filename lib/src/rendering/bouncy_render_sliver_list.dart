...
class BouncySliverConstraints extends SliverConstraints {
  BouncySliverConstraints({
    ...
    required this.springDisplacement,
    required this.pointerOffset,
  });

  final double springDisplacement;
  final double pointerOffset;
}

class BouncyRenderSliverList extends RenderSliverMultiBoxAdaptor {
  @override
  BouncySliverConstraints get constraints =>
      super.constraints as BouncySliverConstraints;
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    while (child != null) {
      ...
      childOffset = constraints.axis == Axis.vertical
          ? childOffset.translate(
              0,
              _springOffset(
                constraints: constraints,
                childScrollOffset: childScrollOffset(child)!,
              ))
          : childOffset.translate(
              _springOffset(
                constraints: constraints,
  ...
  @override
  void performLayout() {
    final BouncySliverConstraints constraints = this.constraints;
  ...
  double _springOffset({
    required BouncySliverConstraints constraints,
    required double childScrollOffset,
  }) {
    final difference = constraints.pointerOffset - childScrollOffset;
    var translate = (difference / 700) * constraints.springDisplacement;
